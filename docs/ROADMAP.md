...
- ✅ **Community** (`/chat`) — o'zbek sotuvchilar bir-biriga yordam beradigan chat: 5 kanal (Umumiy/Narx/Sovuq qo'ng'iroq/Motivatsiya/Savol-javob), har kanalda xabar soni, seed (demo) xabarlar + foydalanuvchi xabarlari localStorage'da (`src/lib/chat.ts` — sof yadro, test bilan qoplangan). Enter bilan yuborish, avto-scroll. Real vaqtli community Supabase ulangach — interfeys o'zgarmaydi.
...
Kalitsiz (mock) rejimda kutish mumkin bo'lgan barcha sahifa/oqim/UI ishi tugallangan: 18 sahifa (landing, ro'yxatdan o'tish, onboarding, bosh sahifa, trener/qo'ng'iroq, e'tirozlar+tezkor mashq, qo'ng'iroq ssenariylari, muzokaralar, vazifalar, ROP paneli, community, analitika, reyting, yutuqlar, tariflar, profil+sozlash, arxiv), sidebar ilova qobig'i, yordam vidjeti — barchasi ishlaydi, o'zaro bog'langan, i18n orqali, typecheck/lint/169 test/build doim yashil.
