...
- 🟡 **Issue #8 — persona katalogi + B2B builder + jamoa dashboard (qisman)**:
  ...
  - ⬜ **Persona o'lchamlari** (lavozim/temperament) va katalog filtrlari — hali qurilmadi (qiyinlik/soha allaqachon bor).
